...
class CustomTopo(Topo):
    def build(self):
        ...
        self.addLink(s5, s1, bw=1, delay="15ms", cls=TCLink)
        self.addLink(s5, s2, bw=1, delay="15ms", cls=TCLink)
        self.addLink(s5, s3, bw=1, delay="15ms", cls=TCLink)
        self.addLink(s5, s4, bw=1, delay="15ms", cls=TCLink)
...
def run():
    ...
    net = Mininet(
        topo=topo, link=TCLink, switch=OVSKernelSwitch, controller=None, build=False
    )
